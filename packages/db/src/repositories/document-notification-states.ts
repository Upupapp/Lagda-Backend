  ...
  return {
    ...
    async setState(
      ...
      try {
        ...
        // are real events in THIS workspace are written at all. This is the
        // ONLY existence check — there is deliberately no foreign key to
        // evidence (see migration 071), and a plain SELECT takes no row lock.
